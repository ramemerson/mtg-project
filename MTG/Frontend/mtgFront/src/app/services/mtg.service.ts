...
export class AccountControllerClient {
     ...
     * @return OK
     */
    create(firstname: string, lastname: string, username: string, password: string, email: string, birthday: string): Observable<Account> {
        ...
        if (birthday === undefined || birthday === null)
            throw new Error("The parameter 'birthday' must be defined and cannot be null.");
        else
            url_ += "birthday=" + encodeURIComponent("" + birthday) + "&";
        url_ = url_.replace(/[?&]$/, "");
